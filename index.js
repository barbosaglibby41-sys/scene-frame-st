...
import { loadSettings, saveSettings } from './core/settings-store.js';
...
const state = { settings: loadSettings(defaults), seen: new Set(), current: null, pending: [], tasks: [], fabDragged: false, page: 'generate', panelOpen: false, panelScrollTop: 0, parserPreview: '' };
function save() { saveSettings(state.settings); }
